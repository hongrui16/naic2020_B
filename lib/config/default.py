...
_C.PIN_MEMORY = True
_C.RANK = 0
_C.ASSETS_PATH = './large_asset_dir'
...
_C.DATASET.CLASS_UNIFORM_PCT = 0.5
_C.DATASET.CLASS_UNIFORM_TILE = 1024
_C.DATASET.CENTROID_ROOT = \
  os.path.join(_C.ASSETS_PATH, 'uniform_centroids')
_C.DATASET.CLASS_UNIFORM_BIAS = None
# training
_C.TRAIN = CN()
