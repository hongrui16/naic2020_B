...
def main():
    ...
    train_dataset = eval('datasets.'+config.DATASET.DATASET)(
                        data_path=config.DATASET.TRAIN_SET,
    ...
    if config.DATASET.EXTRA_TRAIN_SET:
        extra_train_dataset = eval('datasets.'+config.DATASET.DATASET)(
                        data_path=config.DATASET.EXTRA_TRAIN_SET,
                        num_classes=config.DATASET.NUM_CLASSES,
                        multi_scale=config.TRAIN.MULTI_SCALE,
                        flip=config.TRAIN.FLIP,
                        ignore_label=config.TRAIN.IGNORE_LABEL,
    ...
    test_dataset = eval('datasets.'+config.DATASET.DATASET)(
                        data_path=config.DATASET.VAL_SET,
                        num_classes=config.DATASET.NUM_CLASSES,
                        multi_scale=False,
                        flip=False,
                        ignore_label=config.TRAIN.IGNORE_LABEL,
...
#--------------------------------------------
    ...
    if config.TRAIN.OPTIMIZER == 'sgd':
        ...
        if config.TRAIN.NONBACKBONE_KEYWORDS:
            ...
            params = [{'params': filter(lambda p: p.requires_grad, model.parameters()), 'lr': config.TRAIN.LR}]
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        if epoch >= config.TRAIN.END_EPOCH:
            current_trainloader = extra_trainloader
            extra_train_dataset.build_epoch()
        else:
